    ...
    > 
      ...
      <View className="flex-row justify-center">
       <CachedImage
        ...
        style={{width:wp(98),height: hp(50), borderRadius: 53, borderBottomLeftRadius: 40,borderBottomRightRadius: 40, marginTop: 40}}
        />
        </View>

        {/* back  button*/}
        <Animated.View entering={FadeIn.delay(200).duration(1000)} className="w-full absolute flex-row justify-between items-center pt-14" >
            <TouchableOpacity onPress={()=> navigation.goBack()} className="p-z rounded-full ml-5 bg-white" >
                <ChevronLeftIcon size={(hp(3.5))} strokeWidth={4.5} color="green"/>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=> setIsFavourite(!isFavourite)} className="p-z rounded-full ml-5 bg-white" >
            ...
            loading?(
                ...
                <View className="px-4 flex justify-between space-y-4 pt-8">
                    ...
                    <Animated.View entering={FadeInDown.delay(100).duration(700).springify().damping(12)} className="flex-row justify-around" >
                        ...
                        <View className="flex rounded-full bg-green-300 p-2" >
                            <View
